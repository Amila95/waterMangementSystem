...
import { addReportDetails } from '../../actions/reportAction';
...
class index extends Component {
  ...
  onSubmit =(e) =>{
    ...
    //console.log(newUser);
    this.props.addReportDetails(userData, this.props.history);
  }
            ...
            <Card>
              ...
              <CardBody>
                ...
                <FormGroup>
                  ...
                  <Input type="text" id="client" placeholder="Enter client" name="client" value={this.props.client.client.clientName} onChange={this.onChange}/>
...
export default connect (mapStateToProps,{addReportDetails})(withRouter(index));
